...
import landingCommonStyles from "@/app/styles/screens/landing.style";
import styles from "@/app/styles/screens/onboarding.sytle";
    ...
    >
      <View style={landingCommonStyles.infoContainer}>
        ...
        <TouchableOpacity
          ...
          onPress={() =>
            router.replace("/screens/onboarding/onboarding-screen-five.screen")
          }
        >
          <Image
